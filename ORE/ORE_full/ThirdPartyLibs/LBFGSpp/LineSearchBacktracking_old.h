...
class LineSearchBacktracking_old
{
private:
...
public:
    ...
    // static int LineSearch(Foo& f, const LBFGSParam<Scalar>& param,
                           ...
                           Scalar& step, Scalar& fx, Vector& grad, Scalar& dg, Vector& x)
    {
        ...
        for (iter = 0; iter < param.max_linesearch; iter++)
        {
            ...
            else
            {
                ...
                // const Scalar dg = f.getDg(drt, x, fx, grad);
