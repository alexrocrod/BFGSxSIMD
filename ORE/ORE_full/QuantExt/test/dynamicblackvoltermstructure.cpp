...
BOOST_AUTO_TEST_CASE(testConstantVarianceStickyStrike) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.5, 0.80), d.refVol->blackVol(0.5, 0.80), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.5, 0.90), d.refVol->blackVol(0.5, 0.90), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.5, 0.95), d.refVol->blackVol(0.5, 0.95), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.5, 1.15), d.refVol->blackVol(0.5, 1.15), tol);

    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.5, 0.80), d.refVol->blackVol(1.5, 0.80), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.5, 0.90), d.refVol->blackVol(1.5, 0.90), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.5, 0.95), d.refVol->blackVol(1.5, 0.95), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.5, 1.15), d.refVol->blackVol(1.5, 1.15), tol);

    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(5.0, 0.80), d.refVol->blackVol(5.0, 0.80), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(5.0, 0.90), d.refVol->blackVol(5.0, 0.90), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(5.0, 0.95), d.refVol->blackVol(5.0, 0.95), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(5.0, 1.15), d.refVol->blackVol(5.0, 1.15), tol);

    // check atm vol retrieval via null strike (atm is spot here)

    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.5, Null<Real>()), d.refVol->blackVol(0.5, d.spot->value()), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.5, Null<Real>()), d.refVol->blackVol(1.5, d.spot->value()), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(5.0, Null<Real>()), d.refVol->blackVol(5.0, d.spot->value()), tol);
    ...
    d.spot->setValue(0.9);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.7, 0.80), d.refVol->blackVol(0.7, 0.80), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.7, 0.90), d.refVol->blackVol(0.7, 0.90), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.7, 0.95), d.refVol->blackVol(0.7, 0.95), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.7, 1.15), d.refVol->blackVol(0.7, 1.15), tol);

    Settings::instance().evaluationDate() = TARGET().advance(d.origRefDate, 18 * Months);
    d.rate->setValue(0.01);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.7, 0.80), d.refVol->blackVol(1.7, 0.80), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.7, 0.90), d.refVol->blackVol(1.7, 0.90), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.7, 0.95), d.refVol->blackVol(1.7, 0.95), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.7, 1.15), d.refVol->blackVol(1.7, 1.15), tol);

    Settings::instance().evaluationDate() = TARGET().advance(d.origRefDate, 3 * Years);
    d.div->setValue(0.03);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.71, 0.80), d.refVol->blackVol(1.71, 0.80), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.71, 0.90), d.refVol->blackVol(1.71, 0.90), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.71, 0.95), d.refVol->blackVol(1.71, 0.95), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.71, 1.15), d.refVol->blackVol(1.71, 1.15), tol);
...
BOOST_AUTO_TEST_CASE(testConstantVarianceStickyLogMoneyness) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.7, atm * std::exp(-0.25)), d.refVol->blackVol(0.7, atm0 * std::exp(-0.25)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.7, atm * std::exp(0.00)), d.refVol->blackVol(0.7, atm0 * std::exp(0.00)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(0.7, atm * std::exp(0.25)), d.refVol->blackVol(0.7, atm0 * std::exp(0.25)), tol);

    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.7, atm * std::exp(-0.25)), d.refVol->blackVol(1.7, atm0 * std::exp(-0.25)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.7, atm * std::exp(0.00)), d.refVol->blackVol(1.7, atm0 * std::exp(0.00)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.7, atm * std::exp(0.25)), d.refVol->blackVol(1.7, atm0 * std::exp(0.25)), tol);

    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(3.0, atm * std::exp(-0.25)), d.refVol->blackVol(3.0, atm0 * std::exp(-0.25)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(3.0, atm * std::exp(0.00)), d.refVol->blackVol(3.0, atm0 * std::exp(0.00)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(3.0, atm * std::exp(0.25)), d.refVol->blackVol(3.0, atm0 * std::exp(0.25)), tol);
    ...
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.8, atm * std::exp(-0.25)), d.refVol->blackVol(1.8, atm0 * std::exp(-0.25)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.8, atm * std::exp(0.00)), d.refVol->blackVol(1.8, atm0 * std::exp(0.00)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.8, atm * std::exp(0.25)), d.refVol->blackVol(1.8, atm0 * std::exp(0.25)), tol);
    ...
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(3.5, atm * std::exp(-0.25)), d.refVol->blackVol(3.5, atm0 * std::exp(-0.25)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(3.5, atm * std::exp(0.00)), d.refVol->blackVol(3.5, atm0 * std::exp(0.00)), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(3.5, atm * std::exp(0.25)), d.refVol->blackVol(3.5, atm0 * std::exp(0.25)), tol);
...
BOOST_AUTO_TEST_CASE(testForwardVarianceStickyStrike) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.5, 0.80), d.refVol->blackForwardVol(t, t + 1.5, 0.80), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.5, 0.90), d.refVol->blackForwardVol(t, t + 1.5, 0.90), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.5, 0.95), d.refVol->blackForwardVol(t, t + 1.5, 0.95), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVol(1.5, 1.15), d.refVol->blackForwardVol(t, t + 1.5, 1.15), tol);
...
BOOST_AUTO_TEST_CASE(testForwardVarianceStickyLogMoneyness) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(dyn->blackVariance(1.5, atm * std::exp(-0.25)),
                      d.refVol->blackVariance(t + 1.5, atm0 * std::exp(-0.25)) -
                          d.refVol->blackVariance(t, atm0 * std::exp(-0.25)),
                      tol);
    BOOST_CHECK_CLOSE_PASSIVE(
