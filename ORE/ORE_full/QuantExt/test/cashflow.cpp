...
BOOST_AUTO_TEST_CASE(testFXLinkedCashFlow) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(fxlcf1.amount(), 112000000.0, 1e-10);

    BOOST_TEST_MESSAGE("Check todays flow is correct");
    BOOST_CHECK_CLOSE_PASSIVE(fxlcf2.amount(), 123450000.0, 1e-10);
    ...
    BOOST_CHECK_CLOSE_PASSIVE(fxlcf3.amount(), foreignAmount * fwd, 1e-10);
...
BOOST_AUTO_TEST_CASE(testEquityCoupon) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(eq1.amount(), expectedAmount, 1e-10);
    ...
    BOOST_CHECK_CLOSE_PASSIVE(eq2.amount(), expectedAmount, 1e-10);
    ...
    BOOST_CHECK_CLOSE_PASSIVE(eq3.amount(), expectedAmount, 1e-10);
    ...
    BOOST_CHECK_CLOSE_PASSIVE(eq4.amount(), expectedAmount, 1e-10);
}
