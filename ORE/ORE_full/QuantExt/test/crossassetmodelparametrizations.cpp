...
BOOST_AUTO_TEST_CASE(testIrLgm1fParametrizations) {
    ...
    while (t < 100.0) {
        ...
        if (std::fabs(t - static_cast<int>(Integer2(t + 0.5))) > h) {
        ...
        if (std::fabs(t - static_cast<int>(Integer2(t + 0.5))) > h2) {
        ...
        if (std::fabs(t - static_cast<int>(Integer2(t + 0.5))) > h) {
            // same as above, we avoid to test the grid points
            check2("irlgm1f_4.Hprime", t, irlgm1f_4.Hprime(t), Hprime4, 2*1.0E-6);
            check2("irlgm1f_5.Hprime", t, irlgm1f_5.Hprime(t), Hprime5, 2*1.0E-6);
