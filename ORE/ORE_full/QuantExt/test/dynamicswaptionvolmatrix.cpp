...
BOOST_AUTO_TEST_CASE(testConstantVariance) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(dyn->volatility(1 * Months, 1 * Years, strike),
                      d.atmSurface->volatility(1 * Months, 1 * Years, strike), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->volatility(1 * Months, 2 * Years, strike),
                      d.atmSurface->volatility(1 * Months, 2 * Years, strike), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->volatility(1 * Years, 1 * Years, strike),
                      d.atmSurface->volatility(1 * Years, 1 * Years, strike), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->volatility(1 * Years, 2 * Years, strike),
    ...
    BOOST_CHECK_CLOSE_PASSIVE(dyn->volatility(0.1, 1.0, strike), d.atmSurface->volatility(0.1, 1.0, strike), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->volatility(0.1, 2.0, strike), d.atmSurface->volatility(0.1, 2.0, strike), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->volatility(1.0, 1.0, strike), d.atmSurface->volatility(1.0, 1.0, strike), tol);
    BOOST_CHECK_CLOSE_PASSIVE(dyn->volatility(1.0, 2.0, strike), d.atmSurface->volatility(1.0, 2.0, strike), tol);
