...
struct Lgm31fTestData {
    Lgm31fTestData() : refDate(18, Dec, 2015), yts(boost::make_shared<FlatForward>(refDate, 0.02, ActualActual())) {
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_EUR[i] - (i == 0 ? Real(0.0) : zeta_EUR[i - 1])) /
                                 (irTimes[i] - (i == 0 ? Real(0.0) : irTimes[i - 1])));
            lambda[i] =
                std::sqrt((H_EUR[i] - (i == 0 ? Real(0.0) : H_EUR[i - 1])) / (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_GBP[i] - (i == 0 ? Real(0.0): zeta_GBP[i - 1])) /
                                 (irTimes[i] - (i == 0 ? Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_USD[i] - (i == 0 ?  Real(0.0) : zeta_USD[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_JPY[i] - (i == 0 ?  Real(0.0) : zeta_JPY[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_AUD[i] - (i == 0 ?  Real(0.0) : zeta_AUD[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_CAD[i] - (i == 0 ?  Real(0.0) : zeta_CAD[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_CHF[i] - (i == 0 ?  Real(0.0) : zeta_CHF[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_DKK[i] - (i == 0 ?  Real(0.0) : zeta_DKK[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_NOK[i] - (i == 0 ?  Real(0.0) : zeta_NOK[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        Real zeta_PLN[] = { 9.0701982e-06, 1.0608339e-05, 1.1620875e-05, 0.00015177493, 0.00031122807, 0.00046892033,
                            ...
                            0.0020329435,  0.0026210991,  0.0032963998,  0.004125193,   0.0045825323 };
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_PLN[i] - (i == 0 ?  Real(0.0) : zeta_PLN[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_SEK[i] - (i == 0 ?  Real(0.0) : zeta_SEK[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        Real zeta_SGD[] = { 9.0701982e-06, 1.0608339e-05, 1.1620875e-05, 0.00015177493, 0.00031122807, 0.00046892033,
                            ...
                            0.0020329435,  0.0026210991,  0.0032963998,  0.004125193,   0.0045825323 };
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_SGD[i] - (i == 0 ?  Real(0.0) : zeta_SGD[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        Real zeta_INR[] = { 9.0701982e-06, 1.0608339e-05, 1.1620875e-05, 0.00015177493, 0.00031122807, 0.00046892033,
                            ...
                            0.0020329435,  0.0026210991,  0.0032963998,  0.004125193,   0.0045825323 };
        for (Size i = 0; i < LENGTH(irTen); ++i) {
            alpha[i] = std::sqrt((zeta_INR[i] - (i == 0 ?  Real(0.0) : zeta_INR[i - 1])) /
                                 (irTimes[i] - (i == 0 ?  Real(0.0) : irTimes[i - 1])));
        }
        ...
        for (Size i = 0; i < LENGTH(inflTen); ++i) {
            lambdaInfl[i] = std::sqrt((H_BGL[i] - (i == 0 ?  Real(0.0) : H_BGL[i - 1])) /
                                      (inflTimes[i] - (i == 0 ?  Real(0.0) : inflTimes[i - 1])));
        ...
        for (Size i = 0; i < LENGTH(inflTen); ++i) {
            lambdaInfl[i] = std::sqrt((H_BYR[i] - (i == 0 ?  Real(0.0) : H_BYR[i - 1])) /
                                      (inflTimes[i] - (i == 0 ?  Real(0.0) : inflTimes[i - 1])));
        ...
        for (Size i = 0; i < LENGTH(inflTen); ++i) {
            lambdaInfl[i] = std::sqrt((H_CZK[i] - (i == 0 ?  Real(0.0) : H_CZK[i - 1])) /
                                      (inflTimes[i] - (i == 0 ?  Real(0.0) : inflTimes[i - 1])));
...
BOOST_AUTO_TEST_CASE(testLgm31fMartingaleProperty) {
    ...
    for (Size i = 0; i < paths; ++i) {
        ...
        for (Size ii = 0; ii < nIr; ++ii) {
            if (ii == 0) {
                // domestic currency
                e_eu2[ii](AAD_PASSIVE(1.0 / d.xmodel->numeraire(0, T, path.value[0].back())));
            } else {
                // foreign currencies
                e_eu2[ii](AAD_PASSIVE(std::exp(path.value[nIr + (ii - 1)].back()) /
