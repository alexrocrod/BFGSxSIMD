...
public:
    ...
    */
    ...
    void calibrate(int& aadc_i_ 
                            , Handle<YieldTermStructure> curve
                            , bool use_aadc_
                            , bool shift_
                            ,  aadc::VectorArg& curve_args
                            ,
                            const std::vector<boost::shared_ptr<CalibrationHelperBase> >&, OptimizationMethod& method,
                           const EndCriteria& endCriteria, const Constraint& constraint = Constraint(),
                           const std::vector<Real>& weights = std::vector<Real>(),
                           const std::vector<bool>& fixParameters = std::vector<bool>());
    ...
    void calibrate(int& aadc_i_ 
                                        ...
                                        const Constraint& additionalConstraint, const std::vector<Real>& weights,
