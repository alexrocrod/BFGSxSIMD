...
BOOST_AUTO_TEST_CASE(testCommodityVolCurveTypeConstant) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(0.25, 1000.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(0.25, 1200.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 3 * Months, 1000.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 3 * Months, 1200.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(50.0, 1000.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(50.0, 1200.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 50 * Years, 1000.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 50 * Years, 1200.0), configuredVolatility, testTolerance);
}
...
BOOST_AUTO_TEST_CASE(testCommodityVolCurveTypeCurve) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 1 * Years, 1000.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 1 * Years, 1200.0), configuredVolatility, testTolerance);

    configuredVolatility = 0.10;
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 2 * Years, 1000.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 2 * Years, 1200.0), configuredVolatility, testTolerance);

    configuredVolatility = 0.09;
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 5 * Years, 1000.0), configuredVolatility, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 5 * Years, 1200.0), configuredVolatility, testTolerance);
    ...
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 3 * Years, 1000.0), v, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 3 * Years, 1200.0), v, testTolerance);
    // at 6 years, extrapolation is with a flat vol
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 6 * Years, 1000.0), v_e, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 6 * Years, 1200.0), v_e, testTolerance);
}
...
BOOST_AUTO_TEST_CASE(testCommodityVolCurveTypeSurface) {
    ...
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 1 * Years, 1150.0), 0.105, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 1 * Years, 1190.0), 0.115, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 2 * Years, 1150.0), 0.095, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 2 * Years, 1190.0), 0.105, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 5 * Years, 1150.0), 0.085, testTolerance);
    BOOST_CHECK_CLOSE_PASSIVE(volatility->blackVol(asof + 5 * Years, 1190.0), 0.095, testTolerance);
}
