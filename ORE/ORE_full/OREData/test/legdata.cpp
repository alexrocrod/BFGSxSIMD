...
BOOST_AUTO_TEST_CASE(testLegDataNotionals) {
    ...
    vector<Real> notionals = {100, 200, 300};
    ...
    vector<Real> notionalsOut = buildScheduledVector(notionals, dates, s);
...
BOOST_AUTO_TEST_CASE(testLegDataCashflows) {
    ...
    vector<Real> amounts = {1000000, 2000000, 3000000};
