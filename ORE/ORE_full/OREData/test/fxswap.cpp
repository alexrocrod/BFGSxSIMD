...
void test(string nearDate, string farDate, string nearBoughtCurrency, Real nearBoughtAmount, string nearSoldCurrency,
          Real nearSoldAmount, Real farBoughtAmount, Real farSoldAmount) {
