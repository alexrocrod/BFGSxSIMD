...
public:
    ...
    // virtual void markYieldCurvesAsInput (map<tuple<string, YieldCurveType, string>, AADCCurveData>& curves_data,bool full_curves=true) {}
    virtual void markYieldCurvesAsInput (map<tuple<string, YieldCurveType, string>, AADCCurveData>& curves_data) {}
    virtual void markYieldCurvesAsInput (map<tuple<string, YieldCurveType, string>, AADCCurveData>& curves_data, tuple<string, YieldCurveType, string> &key) {}
    // virtual void saveYieldCurvesData (map<tuple<string, YieldCurveType, string>, AADCCurveData>& curves_data,bool full_curves=true) {}
    virtual void saveYieldCurvesData (map<tuple<string, YieldCurveType, string>, AADCCurveData>& curves_data) {}
    virtual void saveYieldCurvesData (map<tuple<string, YieldCurveType, string>, AADCCurveData>& curves_data, tuple<string, YieldCurveType, string> &key) {}
    virtual void markYieldCurvesOutput(map<tuple<string, YieldCurveType, string>, aadc::VectorRes>& curves_outargs_) {}
    virtual void shift (int i, Real coeff, tuple<string, YieldCurveType, string> curve_key) {}
    //@}
};
} // namespace data
} // namespace ore
