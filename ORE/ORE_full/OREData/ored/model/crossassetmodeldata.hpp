...
public:
    ...
    CrossAssetModelData( //! Vector of IR model specifications
        ...
        const map<pair<string, string>, double>& c,
    ...
    CrossAssetModelData( //! Vector of IR model specifications
        ...
        const std::map<std::pair<std::string, std::string>, double>& c,
        //! Bootstrap tolerance used in model calibration
        Real tolerance = 1e-4)
    ...
    const map<pair<string, string>, double>& correlations() const { return correlations_; }
    ...
    map<pair<string, string>, double>& correlations() { return correlations_; }
...
private:
    ...
    map<pair<string, string>, double> correlations_;
