...
typedef QuantLib::QLBool QLBool;
...
public:
    ...
    QLBool isExercised() const { return exercised_; }
...
#ifdef AADC_QL                
    mutable QLBool exercised_;
    mutable iint exerciseDate_;
#else
    mutable QLBool exercised_;
    mutable int exerciseDate_;
#endif

    virtual QLBool exercise() const = 0;
};
...
protected:
    QLBool exercise() const override;
};
