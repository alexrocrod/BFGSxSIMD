...
public:
    ...
    virtual Real value() const = 0;  // delta or cross gamma
    virtual Real value2() const = 0; // diagonal gamma
...
public:
    ...
    virtual void add(const std::string& tradeId, const std::string& factor, const std::string& factor2,
                     const Real value, const Real value2);
    ...
    virtual Real value() const override;
    virtual Real value2() const override;
...
private:
    ...
    std::vector<Real> value_, value2_;
};
