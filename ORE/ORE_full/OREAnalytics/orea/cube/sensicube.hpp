...
//! Sensi cube with single precision Realing point numbers.
using SinglePrecisionSensiCube = SensiCube<Real>;

//! Sensi cube with double precision Realing point numbers.
using DoublePrecisionSensiCube = SensiCube<Real>;
