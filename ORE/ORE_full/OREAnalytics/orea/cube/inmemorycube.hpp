...
//! InMemoryCube of depth 1 with single precision Realing point numbers.
using SinglePrecisionInMemoryCube = InMemoryCube1<Real>;

//! InMemoryCube of depth 1 with Real precision Realing point numbers.
using DoublePrecisionInMemoryCube = InMemoryCube1<Real>;

//! InMemoryCube of depth N with single precision Realing point numbers.
using SinglePrecisionInMemoryCubeN = InMemoryCubeN<Real>;

//! InMemoryCube of depth N with Real precision Realing point numbers.
using DoublePrecisionInMemoryCubeN = InMemoryCubeN<Real>;
} // namespace analytics
} // namespace ore
