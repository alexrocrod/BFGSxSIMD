...
namespace QuantLib {
    ...
    Real AssetOrNothingPayoff::operator()(Real price) const {
        switch (type_) {
          case Option::Call:
            return (price-strike_ > 0.0 ? price :Real(0.0));
          case Option::Put:
            return (strike_-price > 0.0 ? price : Real(0.0));
          default:
            QL_FAIL("unknown/illegal option type");
        }
    }
    ...
    Real CashOrNothingPayoff::operator()(Real price) const {
        switch (type_) {
          case Option::Call:
            return (price-strike_ > 0.0 ? cashPayoff_ : Real(0.0));
          case Option::Put:
            return (strike_-price > 0.0 ? cashPayoff_ : Real(0.0));
          default:
            QL_FAIL("unknown/illegal option type");
        }
    }
    ...
    Real GapPayoff::operator()(Real price) const {
        switch (type_) {
          case Option::Call:
            return (price-strike_ >= 0.0 ? price-secondStrike_ : Real(0.0));
          case Option::Put:
            return (strike_-price >= 0.0 ? secondStrike_-price : Real(0.0));
          default:
            QL_FAIL("unknown/illegal option type");
        }
    }
    ...
    Real SuperFundPayoff::operator()(Real price) const {
        return (price>=strike_ && price<secondStrike_) ? price/strike_ : Real(0.0);
    }
    ...
    Real SuperSharePayoff::operator()(Real price) const {
        return (price>=strike_ && price<secondStrike_) ? cashPayoff_ : Real(0.0);
    }
