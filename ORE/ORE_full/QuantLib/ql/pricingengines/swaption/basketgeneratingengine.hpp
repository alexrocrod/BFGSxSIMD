...
namespace QuantLib {
  ...
  Disposable<Array> valuesA(int& aadc_i_ 
                                        ...
                                        ,
        const Array& params)  const {Array t(1); return t;}
            Disposable<Array> values(const Array &v) const {
                ...
                Size years = (Size)stdpassive::floor(maturity);
                maturity -= (Real)years;
                maturity *= 12.0;
                Size months = (Size)stdpassive::floor(maturity);
                ...
                // Size days = (Size)stdpassive::floor(maturity);
