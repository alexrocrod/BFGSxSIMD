    ...
    */
    ...
    inline TimeGrid MCVarianceSwapEngine<RNG,S>::timeGrid() const {
        ...
        if (timeSteps_ != Null<Size>()) {
            ...
            Size steps = static_cast<Size>(Size2(timeStepsPerYear_*t));
        ...
        class Integrand {
          public:
            ...
            Real operator()(Time t) const {
                Size i =  static_cast<Size>(Size2(t/path_.timeGrid().dt(0)));
    ...
    inline Real VariancePathPricer::operator()(const Path& path) const {
        ...
        SegmentIntegral integrator(static_cast<Size>(Size2(t/dt)));
