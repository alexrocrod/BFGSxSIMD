...
typedef boost::random::normal_distribution<QuantLib::BoostReal> BoostNormalDistribution;
    ...
    */
    ...
    public:
        ...
        : DistributionRandomWalk<BoostNormalDistribution>(
                           BoostNormalDistribution(0.0, AAD_PASSIVE(sigma)), AAD_PASSIVE(delta), AAD_PASSIVE(seed)){}
    };
