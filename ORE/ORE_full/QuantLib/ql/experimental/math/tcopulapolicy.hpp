...
namespace QuantLib {
    ...
    */
    ...
    public:
        ...
        */
        ...
        Probability cumulativeZ(Real z) const {
            return AADBOOST::math::cdf(distributions_.back(), z / 
        ...
        */
        Probability density(const std::vector<Real>& m) const {
            ...
            for(Size i=0; i<m.size(); i++) 
                prodDensities *= AADBOOST::math::pdf(distributions_[i], 
        ...
        */
        Real inverseCumulativeZ(Probability p) const {
            return AADBOOST::math::quantile(distributions_.back(), p)
                * varianceFactors_.back();
        }
        /*! Returns the inverse of the cumulative distribution of the 
    ...
    #endif
            return AADBOOST::math::quantile(distributions_[iFactor], p)
