...
namespace QuantLib {
    ...
    EndCriteria::Type LevenbergMarquardt::minimize(int& aadc_i_ 
        ...
        */
        ...
        Real a=P.costFunction().values(x_)[0];
        Real b=P.costFunction().values(xh_)[0];
        x_[0]=x_[0]-a*h/(b-a);
        xh_[0]=x_[0]+h;
       
         a=P.costFunction().values(x_)[0];
       
        b=P.costFunction().valuesA(aadc_i_ 
                                                    , curve
                                                    , use_aadc_
                                                    , shift_
                                                    , curve_args
