...
namespace QuantLib {
    ...
    Real FilonIntegral::integrate(const boost::function<Real (Real)>& f,
        ...
        switch(type_) {
          case Cosine:
            f1 = static_cast<Real(*)(Real)>(aadc::sin<Real>);
            f2 = static_cast<Real(*)(Real)>(aadc::cos<Real>);
            break;
          case Sine:
            f1 = static_cast<Real(*)(Real)>(aadc::cos<Real>);
            f2 = static_cast<Real(*)(Real)>(aadc::sin<Real>);
            break;
          default:
