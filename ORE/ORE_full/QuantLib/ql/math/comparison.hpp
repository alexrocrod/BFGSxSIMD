...
//     */
// #ifdef AADC_QL
//     QLBool close(Real x, Real y);
//     QLBool close(Real x, Real y, Size n);
// #endif    
//     bool close(double x, double y);
//     bool close(double x, double y, Size n);
...
//     */
// #ifdef AADC_QL
//     QLBool close_enough(Real x, Real y);
//     QLBool close_enough(Real x, Real y, Size n);
// #endif
//     bool close_enough(double x, double y);
//     bool close_enough(double x, double y, Size n);

//     // inline definitions
// #ifdef AADC_QL
//     inline QLBool close(Real x, Real y) {
//         return close(x,y,42);
//     }
//     inline bool close_passive(Real x, Real y) {
//         return close(x,y,42);
//     }

//     inline QLBool close(Real x, Real y, Size n) {
//         // Deals with +infinity and -infinity representations etc.
//         Real diff = std::fabs(x-y), tolerance = n * QL_EPSILON;

//         return iIf (x == y
//             , true
//             , iIf( (x * y == 0.0) // x or y = 0.0
//                 , diff < (tolerance * tolerance)
//                 , diff <= tolerance*std::fabs(x)
//                 && diff <= tolerance*std::fabs(y)
//             )
//         );
//     }

//     inline QLBool close_enough(Real x, Real y) {
//         return close_enough(x,y,42);
//     }

//     inline bool close_enough_passive(Real x, Real y) {
//         return (close_enough(x,y,42));
//     }

//     inline QLBool close_enough(Real x, Real y, Size n) {
//         // Deals with +infinity and -infinity representations etc.
...
//     }
// #else
//     inline bool close_enough_passive(double x, double y) {
//         return close_enough(x,y,42);
//     }
//     inline bool close_passive(double x, double y) {
//         return close(x,y,42);
//     }
// // #endif
