      ...
      public:
        struct cFunction {
            ...
            Real operator()(Real k) {
                ...
                Real d2 = d1 - s_;
                return f_ * AADBOOST::math::cdf(normal, d1) -
                       k * AADBOOST::math::cdf(normal, d2) + a_ * k + b_;
            }
            Real f_, s_, a_, b_;
        ...
        struct aHelper {
            ...
            Real operator()(Real a) const {
                boost::math::normal normal;
                Real d20 = AADBOOST::math::quantile(normal, -c0p_ + a);
                Real d21 = AADBOOST::math::quantile(normal, -c1p_ + a);
        ...
        struct sHelper {
            ...
            Real operator()(Real s) const {
                s = std::max(s, 0.0);
                boost::math::normal normal;
                Real d20 = AADBOOST::math::quantile(normal, -c0p_);
        ...
        struct sHelper1 {
            ...
            Real operator()(Real s) const {
                s = std::max(s, 0.0);
                boost::math::normal normal;
                Real d21 = AADBOOST::math::quantile(normal, -c1p_);
