...
public:
    complex() : re(0), im(0) {}
    complex(const int val) : re(val), im(0) {}
    ...
    complex(const double r, const idouble i) : re(r), im(i) {}
    complex(const idouble r, const double i) : re(r), im(i) {}
   ...
   complex<T>& operator = (const complex<T>& other) {
    ...
    complex& operator=(const idouble& x) {
        re=x;
        im=0;
        return *this; 
    }
...
inline std::complex<idouble> operator+(const std::complex<idouble>& lhs, const int rhs) {
      return complex<idouble>(lhs.real()+rhs,lhs.imag()); 
}
inline std::complex<idouble> operator+(const int lhs, const std::complex<idouble>& rhs) { 
      return complex<idouble>(lhs+rhs.real(),rhs.imag()); 
}
...
inline std::complex<idouble> pow( const std::complex<idouble>& x, int y) { 
    return pow(x, idouble(y));
}
